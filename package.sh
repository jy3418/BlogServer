...
# Test Case4 (5 points): check if request for list of user2's posts starting from postid 1 can be displayed with correct content
posts2 = set([user2_7, user2_others])
isright2 = True
r4 = test_requests(gurl + 'blog/user2?start=1')
for x in posts2:
    if r4.text.find(x) == -1:
        isright2 = False
        break
